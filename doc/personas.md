...
**Какой mode преимущественно использует.** `new-product` (первый продукт через template) → `new-feature` (фичи в собственных продуктах) → реже `rework-feature`.
...
**Какой mode преимущественно использует.** Зависит от ситуации: новый side-project (`new-product`) или фичи в существующем (`new-feature`).
...
**Какой mode преимущественно использует.** Зависит от проекта; чаще всего `new-feature` и `rework-feature` в собственных или поддерживаемых проектах.
