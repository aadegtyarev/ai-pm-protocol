...
- `[rich]` **The cheapest test that would tell us** — the smallest probe (a sketch, a question to one user, a throwaway) that would confirm or kill the bet before the full build earns its cost.
