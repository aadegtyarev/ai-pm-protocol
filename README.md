...
**Новая версия шаблона требует новой документации — видно.** При обновлении шаблона `/pm-audit` показывает PM, какие документационные дисциплины ввела новая версия и которые проект ещё не заполнил.
